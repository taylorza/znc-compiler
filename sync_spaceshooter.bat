...
rem %1/../../emulator/hdfmonkey get %1/../../sdcard/tbblue-dev.sd /zdev/zxbgfxtst.znc tests/zxbgfxtst.znc
...
%1/../../emulator/hdfmonkey put %1/../../sdcard/tbblue-dev.sd tests/zide.bas /zdev/
